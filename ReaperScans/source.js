...
class ReaperScans extends Madara_1.Madara {
    constructor() {
        ...
        this.parser = new ReaperScansParser_1.ReaperScansParser();
    }
}
exports.ReaperScans = ReaperScans;

},{"../Madara":60,"./ReaperScansParser":65,"paperback-extensions-common":14}],65:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReaperScansParser = void 0;
const MadaraParser_1 = require("../MadaraParser");
...
class ReaperScansParser extends MadaraParser_1.Parser {
    async parseSearchResults($, source) {
        ...
        for (const obj of $(source.searchMangaSelector).toArray()) {
            ...
            if (novelIDArray.includes(id))
                continue; //Filter out the novels
            results.push(createMangaTile({
                id: id,
                image: image ? image : 'https://i.imgur.com/GYUxEX8.png',
                title: createIconText({ text: this.decodeHTMLEntity(title) }),
...
exports.ReaperScansParser = ReaperScansParser;

},{"../MadaraParser":62}]},{},[64])(64)
});
